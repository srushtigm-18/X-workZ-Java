class Sunscreen {
    ...
    public Sunscreen(String brandName, String productName, double price, String size, String variant,
    ...
    public Sunscreen() {
        this("SunGuard", "SPF 50 Sunscreen Lotion", 299.0, "100ml", "Broad Spectrum", "Unscented", 100.0,
             "2026-12-31", "2025-03-01", "SS001", 1, "Pump Bottle", 4.7,
             "Avobenzone", "Octinoxate", "Titanium Dioxide", "Zinc Oxide", "SunGuard Ltd", "India");
    }
