class AbodeRunner {
    ...
    public static void main(String[] pdf) {
        ...
        boolean sudeep = abode.createUserAccount(abodeOne);
        ...
        boolean rakshitha = abode.createUserAccount(abodeTwo);
        ...
        boolean nishvika = abode.createUserAccount(abodeThree);
        ...
        boolean prema = abode.createUserAccount(abodeFour);
        ...
        boolean nishka = abode.createUserAccount(abodeFive);
        ...
        boolean arjun = abode.createUserAccount(abodeSix);
        ...
        boolean priya = abode.createUserAccount(abodeSeven);
        ...
        boolean vikas = abode.createUserAccount(abodeEight);
        ...
        boolean anita = abode.createUserAccount(abodeNine);
        ...
        boolean rahul = abode.createUserAccount(abodeTen);
        ...
        boolean sneha = abode.createUserAccount(abodeEleven);
        ...
        boolean karan = abode.createUserAccount(abodeTwelve);
        ...
        boolean divya = abode.createUserAccount(abodeThirteen);
        ...
        boolean rohit = abode.createUserAccount(abodeFourteen);
        ...
        boolean meera = abode.createUserAccount(abodeFifteen);
        ...
        boolean sameer = abode.createUserAccount(abodeSixteen);
        ...
        boolean lakshmi = abode.createUserAccount(abodeSeventeen);
        ...
        boolean tejas = abode.createUserAccount(abodeEighteen);
        ...
        boolean shruti = abode.createUserAccount(abodeNineteen);
